...
void trans_bt_init(int i, uint32_t baud)
{
...
//***************************************************//
#define TRANS_OTHERS_TBUFF_SIZE 7

char trans_others_Tbuff[4][TRANS_OTHERS_TBUFF_SIZE] = {0};
int  trans_others_TFlag[4] = {0};

#define TRANS_OTHERS_RBUFF_SIZE1 7
#define TRANS_OTHERS_RBUFF_SIZE2 7 
#define TRANS_OTHERS_RBUFF_SIZE_MAX 100
uint8_t TRANS_OTHERS_RBUFF_SIZE = 0;

char trans_others_Rbuff[4][TRANS_OTHERS_RBUFF_SIZE_MAX] = {0};
int  trans_others_RFlag[4] = {0};


void trans_others_init(int i, uint32_t baud)
{
	if(i == 2) TRANS_OTHERS_RBUFF_SIZE = TRANS_OTHERS_RBUFF_SIZE1;
	else TRANS_OTHERS_RBUFF_SIZE = TRANS_OTHERS_RBUFF_SIZE2;
