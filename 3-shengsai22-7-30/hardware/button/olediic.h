...
//OLED SSD1306 I2C SCL P4.5
#define OLED_SSD1306_SCL_PIN_NUM (5)
#define OLED_SSD1306_SCL_IO_INIT (BITBAND_PERI(P4DIR, OLED_SSD1306_SCL_PIN_NUM) = 1) // (Set_Bit(P1DIR, OLED_SSD1306_SCL_PIN_NUM))
#define OLED_SCL_Set() (BITBAND_PERI(P4OUT, OLED_SSD1306_SCL_PIN_NUM) = 1)
#define OLED_SCL_Clr() (BITBAND_PERI(P4OUT, OLED_SSD1306_SCL_PIN_NUM) = 0)

//OLED SSD1306 I2C SDA   P4.7
#define OLED_SSD1306_SDA_PIN_NUM (7)
#define OLED_SSD1306_SDA_IO_INIT (BITBAND_PERI(P4DIR, OLED_SSD1306_SDA_PIN_NUM) = 1)
#define OLED_SDA_Set() (BITBAND_PERI(P4OUT, OLED_SSD1306_SDA_PIN_NUM) = 1)
#define OLED_SDA_Clr() (BITBAND_PERI(P4OUT, OLED_SSD1306_SDA_PIN_NUM) = 0)
