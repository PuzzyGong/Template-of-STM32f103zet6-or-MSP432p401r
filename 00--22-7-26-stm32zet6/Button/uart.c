...
static void*	USARTx					[5]	=	{	USART1,					USART2,					USART3,					UART4,					UART5					};
static u32		RCC_APB1Periph_USARTx	[5]	=	{	0,						RCC_APB1Periph_USART2,	RCC_APB1Periph_USART3,	RCC_APB1Periph_UART4,	RCC_APB1Periph_UART5	};
static u32		RCC_APB2Periph_USARTx	[5]	=	{	RCC_APB2Periph_USART1,	0,						0,						0,						0						};

static u32		GPIO_Remap_USARTx		[5]	=	{	0,						GPIO_Remap_USART2,		GPIO_FullRemap_USART3,	0,						0						};

static void*	GPIOx					[5]	=	{	GPIOA,					GPIOD,					GPIOD,					GPIOC,					GPIOC					};
static u32		RCC_APB2Periph_GPIOx	[5]	=	{	RCC_APB2Periph_GPIOA,	RCC_APB2Periph_GPIOD,	RCC_APB2Periph_GPIOD,	RCC_APB2Periph_GPIOC,	RCC_APB2Periph_GPIOC	};
static u32		T_GPIO_Pin_x			[5]	=	{	GPIO_Pin_9,				GPIO_Pin_5,				GPIO_Pin_8,				GPIO_Pin_10,			GPIO_Pin_12				};
static u32		R_GPIO_Pin_x			[5]	=	{	GPIO_Pin_10,			GPIO_Pin_6,				GPIO_Pin_9,				GPIO_Pin_11,			0						};

static u8		USARTx_IRQn				[5]	=	{	USART1_IRQn,			USART2_IRQn,			USART3_IRQn,			UART4_IRQn,				UART5_IRQn				};
				
static u32		RCC_AHBPeriph_DMAx		[5]	=	{	RCC_AHBPeriph_DMA1,		RCC_AHBPeriph_DMA1,		RCC_AHBPeriph_DMA1,		RCC_AHBPeriph_DMA2,		0						};
static void*	T_DMA_Channel_x			[5]	=	{	DMA1_Channel4,			DMA1_Channel7,			DMA1_Channel2,			DMA2_Channel5,			0						};
static void*	R_DMA_Channel_x			[5]	=	{	DMA1_Channel5,			DMA1_Channel6,			DMA1_Channel3,			DMA2_Channel3,			0						};
